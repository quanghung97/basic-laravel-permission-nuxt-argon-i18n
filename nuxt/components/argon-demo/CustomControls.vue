    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          ...
          <base-checkbox v-model="checkboxes.unchecked">Unchecked</base-checkbox>
          <base-checkbox v-model="checkboxes.checked" class="mb-3">Checked</base-checkbox>

          <base-checkbox v-model="checkboxes.uncheckedDisabled" disabled>Unchecked</base-checkbox>
          <base-checkbox v-model="checkboxes.checkedDisabled" disabled>Checked</base-checkbox>
        </div>
        <div class="col-lg-3 col-sm-6 mt-4 mt-md-0">
          ...
          <base-radio v-model="radio.radio1" name="radio0" class="mb-3">Unchecked</base-radio>

          <base-radio v-model="radio.radio1" name="radio1" class="mb-3">Checked</base-radio>

          <base-radio v-model="radio.radio2"
                      name="radio2"
                      class="mb-3"
                      disabled>Disabled unchecked</base-radio>

          <base-radio v-model="radio.radio2"
                      name="radio3"
                      class="mb-3"
                      disabled>Disabled checked</base-radio>
        </div>
        <div class="col-lg-3 col-sm-6 mt-4 mt-md-0">
          <!-- Toggle buttons -->
          <div class="mb-3">
