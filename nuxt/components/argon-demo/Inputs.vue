  ...
  <section class="section pb-0 section-components">
    <div class="container mb-5">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-sm-6">
          <base-input :valid="true" placeholder="Success" ></base-input>

          <base-input :valid="false" placeholder="Success" ></base-input>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-sm-6">
            ...
            <base-input alternative placeholder="Search" addon-left-icon="ni ni-zoom-split-in"></base-input>
          </div>
          <div class="col-lg-4 col-sm-6">
          ...
          <div class="col-lg-4 col-sm-6">
            <base-input :valid="true" alternative placeholder="Success" ></base-input>

            <base-input :valid="false" alternative placeholder="Success" ></base-input>
          </div>
        </div>
      </div>
    </div>
